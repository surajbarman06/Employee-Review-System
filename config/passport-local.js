...
passport.setAuthenticatedUser = function (req, res, next) {
    if (req.isAuthenticated()) {
        //whenever a user is signed_in/authenticated , that user's info in available inside
        // req.user from the session,and attach their information to the response locals
